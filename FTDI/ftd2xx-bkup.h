...
// JBW - 12OCT07: looks like they just changed the name and inverted the meaning in the Windows drivers.
// OSX driver headers did not get rev'd at that time.  Seems safe to just fix the name so it still works.
